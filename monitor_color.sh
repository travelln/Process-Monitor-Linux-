...
#individual elemnt of the column is either a star or a dot. This function is updated to 
#incorporate the use of colors for the bar graph.
function updateCPUGraph(){


	if [ "$cpuUsageValue" -lt "21" ]   #twenty percent or less usage
		then
			cpuArray5[31]="\e[00;32m"*"\e[00m";
	elif [ "$cpuUsageValue" -lt "41" ] #forty percent or less usage	
		then 			   #else if statements ensure only one value is represented	
			cpuArray5[31]="\e[00;32m"*"\e[00m"; #and not performed twice depending on the criteria
			cpuArray4[31]="\e[00;32m"*"\e[00m";
	elif [ "$cpuUsageValue" -lt "61" ] #sixty percent or less usage
		then
			cpuArray5[31]="\e[00;32m"*"\e[00m";
			cpuArray4[31]="\e[00;32m"*"\e[00m";
			cpuArray3[31]="\e[00;33m"*"\e[00m";
	elif [ "$cpuUsageValue" -lt "81" ] #eighty percent or less usage
		then
			cpuArray5[31]="\e[00;32m"*"\e[00m";
			cpuArray4[31]="\e[00;32m"*"\e[00m";
			cpuArray3[31]="\e[00;33m"*"\e[00m";
			cpuArray2[31]="\e[00;33m"*"\e[00m";
...
#the column is either a star or a dot. This function is updated to incorporate the use
...
main   #calls the main function which starts the program
exit 0
